...
export default function Footer() {
  ...
  return (
    <footer className="pt-32 lg:pt-6 pb-16 px-6" style={{backgroundColor: '#FAF9F6'}}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <div>
                <input
                  ...
                  className={`w-full px-4 py-3 rounded-full border-2 transition-all duration-200 ${
                    error
              ...
              <button
                type="submit"
                disabled={isSubmitting}
                className="w-full px-6 py-3 bg-white border-2 border-orange-500 text-orange-500 rounded-full font-medium hover:bg-orange-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isSubmitting ? (
                  <>
                    <svg
          ...
          <div className="lg:col-span-7 lg:order-1 space-y-6">
            {/* Brand Name */}
            <h2 className="text-5xl lg:text-6xl font-bold text-black">YIIVA</h2>
