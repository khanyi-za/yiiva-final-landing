...
const DIVES = [
  ...
  },
  {
    ...
    body: "Products with variants and stock, collections, orders with fulfilment status, returns, team members, earnings statements — the back office that currently lives across multiple platforms, in one place.",
